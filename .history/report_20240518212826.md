...
The waypoints are stored as Waypoint messages, which include latitude , longitude information an oeientation. These messages are appended to the waypoint_list_geo attribute of the class instance.
