...
### steps
  ...
  2. Adds edges to the graph with the calculated path length as the weight. instead of create a graaph with the whole node using the KD-tree for efficient neighbor searching.