...
3. Plan paths between cluste waypoints, taking into account the robot's non-holonomic constraints in the dubins path planning make the orientation of the goal poit to the rectangular cluster orientation 