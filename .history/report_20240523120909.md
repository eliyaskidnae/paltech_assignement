...
- Visualization waypoints in robot frame 
    ...
    <div style="flex: 1; margin-right: 10px;">
        <img src="./paltech_assignment/imgs/waypoints.png" alt="Figure 1" width="250"/>
        <p style="text-align: center;">Waypoints in robot frame = 2*distance</p>
    </div>
    </div>
...
### Path Efficiency Optimization 
  ...
  <div style="display: flex; justify-content: center;">
    <div style="flex: 1; margin-right: 10px;">
        ...
        <p style="text-align: center;"> Dubins Path = 2*distance</p>
    </div>
<!--     
    <div style="flex: 1; margin-right: 10px;">
        <img src="paltech_assignment/imgs/output5.pngpath.png" alt="Figure 2" width="250"/>
