...
### Obstacle Avoidance Considertion 
   ...
   2.State_Validity_Checker: This class, StateValidityChecker, is responsible for checking the validity of robot states (individual positions) and paths (sequences of positions) with respect to an occupancy map 
