...
####U use set_waypoints_callback function is a service callback in the waypoint_manager.py file. It handles requests to load and set waypoints for a robot from a GeoJSON file.
