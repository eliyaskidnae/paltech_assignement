...
### Path Efficiency 
  ...
  2. **Orientation bettewen Way points**:Calculating the angle to the next waypoint based on the slope (i.e., the direction from the current point to the next waypoint) is crucial for ensuring the path adheres to these constraints.
