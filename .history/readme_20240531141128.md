...
1.Use clustering algorithms to group nearby weed positions into clusters. These clusters should consider the dimensions of the rectangular working area.