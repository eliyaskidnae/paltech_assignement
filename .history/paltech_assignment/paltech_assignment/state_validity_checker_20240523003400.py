...
class StateValidityChecker:
    ...
    def set(self, data, origin , tolorance = 0.01):
        '''Set the occupancy map, its resolution and origin.
        Args:
            data (numpy.ndarray): A 2D numpy array containing the obstacle list map.
            origin (tuple): A tuple containing the x and y coordinates of the origin of the map.
