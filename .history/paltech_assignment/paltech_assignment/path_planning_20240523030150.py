...
class PathPlanner:
    def __init__(self, area_size=100, num_points=3, cluster_percentage=0, cluster_std=3, min_turning_radius=2 , k_nearest_neighbors=20):
    ...
    def dubins_path_planner(self):
            ...
            if is_feasible:
                ...
                while not is_feasible and j < len(ordered_waypoints) - 1:
                    ...
                    if is_feasible:
                        ...
                        new_db_pthnew_path = self.rrt.compute_path(ordered_waypoints[i], ordered_waypoints[i + 1])
                        self.path.extend(new_path)
                        self.dubins_path.extend(new_path)
        ...
        print("dubins_path " , self.dubins_path)
    ...
    def execute(self):
        ...
        self.rrt = RRT_DUNIBS(self.svc ,10 ,4, 1 ,self.area_size ,self.min_turning_radius)
