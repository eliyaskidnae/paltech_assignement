...
class PathPlanner:
    def __init__(self, area_size=100, num_points=50, cluster_percentage=0.5, cluster_std=3, min_turning_radius=2 , k_nearest_neighbors=20):
...
if __name__ == "__main__":
    ...
    path_planner = PathPlanner( area_size=100, num_points=50, cluster_percentage=0.5, cluster_std=3, min_turning_radius=2 , k_nearest_neighbors=20)
