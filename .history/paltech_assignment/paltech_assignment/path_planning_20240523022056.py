...
class PathPlanner:
    ...
    def execute(self):
        ...
        self.rrt = RRT_DUNIBS(self.svc ,1000 ,4, 0.2 ,self.area_size , max_time=10 , min_turning_radius = self.min_turning_radius)
        # returns the smooth path and the tree list
        new_dubins_path , new_path = rrt.compute_path(start_p, goal_p )
