...
class StateValidityChecker:
    ...
    def set(self, data, resolution, origin , tolorance = 0.01):
        '''Set the map, resolution, and origin of the occupancy grid.           
        Args:
            data (numpy.ndarray): A 2D numpy array containing the occupancy grid. 
            resolution (float): The resolution of the occupancy grid. 
            origin (tuple): A tuple containing the x and y coordinates of the origin of the occupancy grid. 
        '''
