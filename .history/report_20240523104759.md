...
### Obstacle Avoidance Considertion 
   ...
   2.State_Validity_Checker: TThehis class, `StateValidityChecker`, is responsible for checking the validity ofindividual positions and paths (sequences of positions) with respect to an occupancy map 
