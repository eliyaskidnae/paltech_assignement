...
Another approch could be divide the entire working area into a grid of cells. The size of each cell should be at most the dimensions of the robot's working area.then we can idendefiy cells taht contains weeds. then the robot can go to the cell contains weeds according to the oriention of the grid.